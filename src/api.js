...
export const listStairs     = (levelId)  => invoke("list_stairs", { levelId });
export const addStair       = (stair)    => invoke("add_stair", { stair });
export const putStairs      = (stairs)   => invoke("put_stairs", { stairs });
export const deleteStairs   = (ids)      => invoke("delete_stairs", { ids });
